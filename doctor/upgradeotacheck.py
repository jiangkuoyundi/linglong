...
def mylog(checkone,checktwo,deviceid):
...
# def checksong(checkone,checktwo,deviceid):
#     print('歌曲测试')
    # 单个运行
    # os.system(str(3) + '.wav')
    # testresult = mylog(checkone,checktwo,deviceid)
    # if testresult == True:
    #     print('==========================歌曲测试通过================================')
...
# checksong('transContant = 我要听周杰伦的歌曲。', 'PlayerController OnPlay singerName = 周杰伦','JYZ26840')
